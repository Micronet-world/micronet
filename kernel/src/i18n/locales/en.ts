export default {
  ...
  weather: {
    ...
    noResults: 'No Results',
    noResultsDesc: 'Try a different city name.',
    ...
    noLocationsDesc: 'Search for a city to add it.',
    clearSky: 'Clear',
  ...
  compass: {
    ...
    notAvailable: 'Compass not available',
    notAvailableDesc: 'Device orientation sensor is not supported on this device.',
    altitude: 'Altitude',
    coordinates: 'Coordinates',
    accuracy: 'Accuracy',
    lockHeading: 'Lock Heading',
    unlockHeading: 'Unlock Heading',
  },
}
